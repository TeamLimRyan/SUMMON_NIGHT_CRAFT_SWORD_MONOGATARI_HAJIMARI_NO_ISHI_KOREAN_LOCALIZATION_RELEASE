...
def main() -> None:
    ...
    if status.get("repository") != "TeamLimRyan/SUMMON_NIGHT_CRAFT_SWORD_MONOGATARI_HAJIMARI_NO_ISHI_KOREAN_LOCALIZATION_RELEASE":
    ...
    expected_lines = {
        ...
        f'{status["source"]["sha256"]}  Summon Night - Craft Sword Monogatari - Hajimari no Ishi (Japan).gba',
        f'{status["target"]["sha256"]}  summon_night_craft_sword_hajimari_no_ishi_ko.gba',
    }
    ...
    for directory, names, filenames in os.walk(ROOT):
        ...
        for filename in filenames:
            ...
            if path.suffix.lower() in {".md", ".txt", ".json", ".py", ".yml", ".yaml"}:
                ...
                if ("C:" + "\\sn3\\") in text or ("C:" + "/sn3/") in text:
